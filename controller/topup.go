...
func GetTopUpInfo(c *gin.Context) {
	...
	data := gin.H{
		...
		"stripe_currency":         strings.ToUpper(setting.StripeCurrency),
		"stripe_preset_only":      false,
		"aud_presets":             operation_setting.GetStripeAudPresets(),
		"cny_presets":             operation_setting.GetStripeCnyPresets(),
		"stripe_min_charge_minor": stripeMinChargeMinorUnits,
		"usd_exchange_rate":       operation_setting.Price,
