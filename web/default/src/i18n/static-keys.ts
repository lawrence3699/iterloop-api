...
export const STATIC_I18N_KEYS = [
  ...
  // Clone homepage (dynamic labels passed to t() via constants)
  'OpenAI protocol',
  'Anthropic protocol',
  'your IterLoop API Key',
  'Connect IterLoop to Codex Desktop',
  'Connect IterLoop to Claude Desktop',
  'Connect IterLoop to Claude Code',
  'Connect IterLoop to Codex',
  'Connect IterLoop to your Openclaw',
  ...
  'Trouble downloading or using Codex?',
  'Trouble downloading or using Claude?',
  'Install Claude Code',
  'Install Codex',
  ', create a IterLoop account, issue an API Key, and top up your balance.',
  'Copy config, paste in terminal',
  'Copy the block above and run it in your terminal before launching Claude Code. Persist it however you like.',
  'Copy the block above and run it in your terminal before launching Codex. Persist it however you like.',
  'Launch Claude Code, auto-route',
  'Launch Codex, auto-route',
  'Claude Code will route through IterLoop. Check the dashboard for usage.',
  'Codex will route through IterLoop. Check the dashboard for usage.',
  'Share the install URL',
  'Send the official skill.md link to your Openclaw workspace.',
  'Auto installation',
  'Openclaw installs and validates the IterLoop skill package automatically.',
  'Confirm default gateway',
  'Open the confirmation link and set IterLoop as your default routing gateway.',
  'Model Integrity',
