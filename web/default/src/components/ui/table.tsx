...
function TableBody({ className, ...props }: React.ComponentProps<'tbody'>) {
  return (
    <tbody
      ...
      className={cn('[&>tr]:h-14 [&_tr:last-child]:border-0', className)}
      {...props}
    />
  )
}
...
function TableRow({ className, ...props }: React.ComponentProps<'tr'>) {
  return (
    <tr
      data-slot='table-row'
      className={cn(
        'group data-[state=selected]:bg-accent border-b transition-colors hover:bg-muted has-aria-expanded:bg-muted',
        className
      )}
      {...props}
    />
